    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('tipo-propiedades.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    <!-- Ícono de añadir -->
                                    ...
                                    @foreach ($tipoPropiedades as $tipoPropiedad)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                                <!-- Ver (Color verde) -->
                                                <a href="{{ route('tipo-propiedades.show', $tipoPropiedad->id) }}" class="text-green-600 hover:text-green-800" title="Ver detalles">
                                                ...
                                                <a href="{{ route('tipo-propiedades.edit', $tipoPropiedad->id) }}" class="text-blue-600 hover:text-blue-800" title="Editar">
                                                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <!-- Eliminar (Color rojo) -->
                                                <form class="inline-block" action="{{ route('tipo-propiedades.destroy', $tipoPropiedad->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro?');" title="Eliminar">
                                                    @csrf
                                                    @method('DELETE')
