<nav x-data="{ open: false }" class="bg-cool-gray-300 border-b border-gray-100">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/casa.png') }}" alt="Logo" class="h-16 w-auto">
                    </a>
                </div>
                <!-- Navigation Links -->
              ...
              <!-- Formulario Dropdown -->   
                @canany(['admin_access','cliente_access','propietario_access','agente_access'])
                    <div class="hidden sm:flex sm:items-center sm:ml-10">
                        <x-jet-dropdown align="left">
                            <x-slot name="trigger">
                                <button
                            ...
                            <x-slot name="content">
                                <x-jet-dropdown-link href="{{ route('formulario.index') }}" :active="request()->routeIs('users.*')">
                                    Formulario
                                </x-jet-dropdown-link>
    ...
    @endcan
        ...
        @can('admin_access')
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('propiedades.index') }}" :active="request()->routeIs('propiedades*.')">
                Propiedades
            </x-jet-responsive-nav-link>
        </div>
    @endcan
